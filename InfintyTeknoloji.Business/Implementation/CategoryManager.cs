...
{
   public class CategoryManager : ServiceAbstractBase<Category, CategoryDto>
    {
        public CategoryManager(InfinityTeknolojiDbContext db, IMapper mapper) : base(db, mapper)
        {
        }
    }
}
